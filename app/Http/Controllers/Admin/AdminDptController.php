...
class AdminDptController extends Controller
{
    function index(){
    ...
    function tambah(){
        ...
        $data['desa'] = Desa::get();
        return view('admin.dpt.tambah', $data);
    }
    ...
    function aksitambah(Request $request){
        ...
        if($simpan == 1){
            return redirect('admin/dpt')->with('success', 'Data berhasil ditambahkan !');
        }else{
    ...
    function edit($dpt){
        ...
        $data['koordinator'] = Koordinator::get();
        $data['desa'] = Desa::get();
        return view('admin.dpt.edit', $data);
    }
    ...
    function aksiedit(Request $request, Dpt $dpt){
        if ($request->foto_ktp != null) {
            ...
            if($simpan == 1){
                return redirect('admin/dpt')->with('success', 'Data berhasil diupdate !');
            }else{
    ...
    function hapus(Dpt $dpt){
        ...
        if($simpan == 1){
            return redirect('admin/dpt')->with('success', 'Data berhasil dihapus !');
        }else{
